(function (NioApp, $) {
    ...
    // Basic
    dragula([document.querySelector("#basicLeft"), document.querySelector("#basicRight")]);

    // Basic with list
    dragula([document.querySelector("#basicLeftList"), document.querySelector("#basicRightList")]);

    // Theme
    dragula([document.querySelector("#themeLeft"), document.querySelector("#themeRight")])
        .on('drag', function (el) {
    ...
    // Remove on Spill
    dragula([document.querySelector("#removeSpillLeft"), document.querySelector("#removeSpillRight"), document.querySelector("#not-removeSpillRight2")], {
        removeOnSpill: true
    });

    // Not Remove Spill
    dragula([document.querySelector("#not-removeSpillLeft"), document.querySelector("#not-removeSpillRight"), document.querySelector("#not-removeSpillRight2")], {
        removeOnSpill: false
    });
